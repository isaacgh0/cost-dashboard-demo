...
@Component({
    ...
    template: `
        <div class="w-full h-screen flex">
            <div class="w-1/2 h-full bg-fi-main p-10">
                <div class="flex size-4 relative">
                ...
                <div class="flex flex-col w-full md:w-10/12 mx-auto mt-12">
                    <span class="text-2xl text-black">Diseño intuiitivo para personas</span>
                    <span class="text-base text-black opacity-70">Registra y analiza tus datos financieros con una interfaz sinple y optimizada para mostrar la información más importante.</span>
                </div>
            </div>
            <div class="w-1/2 h-full bg-white flex flex-col items-center justify-center">
                <form class="flex flex-col w-10/12 md:w-2/3 mx-auto" [formGroup]="form">
                    <h1 class="mt-0 mb-16">Iniciar sesión</h1>
                    ...
                    <div class="flex flex-col gap-2 mt-4">
                        ...
                        <p-password
                            ...
                            [toggleMask]="true"
                            />
                        <small class="text-slate-500 -mb-2">Escribe una Contraseña con almenos 8 caracteres</small>
                        <small class="text-slate-500 ">Tu contraseña debe contener almenos un símbolo, una letra minúscula, una letra mayúscula y un número</small>
                    </div>
                    ...
                    <div class="relative my-14 border-b border-b-slate-300 w-full">
                    ...
                    <button
                        ...
                        class="py-4 rounded-md text-fi-main border-fi-main hover:bg-fi-main/10 active:bg-fi-main/20"
                        [outlined]="true"
                        (click)="resetAccess()"
                        >
                    </button>
